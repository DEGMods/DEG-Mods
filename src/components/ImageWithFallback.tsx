...
export const ImageWithFallback: React.FC<ImageWithFallbackProps> = ({
  ...
  // ── Tampered state — show image with a small "modified" pill badge ──
  if (state === 'tampered') {
    return (
      <div className="image-with-fallback-container IBMSMSCWSPicWrapper">
        <img
        ...
        />
        <div
          className="image-tampered-badge"
          title="The original image file has been modified by the image host"
        >
          <span>modified</span>
        </div>
      </div>
